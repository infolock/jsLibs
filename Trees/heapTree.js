...
//        BEGIN TREE
  ...
  function IndexPath = function(x,y) {
    this.x = -1;
    this.y = -1;
  }

  // Generates a new Node
  function Node = function(dataValue) {
    this.dataValue = dataValue;
    this.indexPath = new IndexPath(0,0),
    this.leftEdgeIndex = -1;
    this.rightEdgeIndex = -1;
  };
  ...
  function Graph(nodes) {
    ...
    function createNode(nodeValue, nodeIndex) {
      var Node = NodeBuilder.spawnNode();
